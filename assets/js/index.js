...
function changeChemicals(v,s,r){
		...
		var button2 = document.getElementById("buttombutton");
...
function changeDimensions() {
		...
		if(current>100 && (fillcolor=="#01DFA5" || fillcolor=="#00BFFF" || fillcolor=="#E6E6E6"
		...
		else if(current>=39 && current <=170 && fillcolor=="#E6E6F6" && click==0)
		{
			showme.style.display = "";
			if(showme.style.visibility == "hidden" ) {
				showme.style.visibility = "visible";
		...
		else if(current>=39 && current<=170 && fillcolor=="#F2F2F2" && clicks==0)
		{
			showme.style.display = "";
			if(showme.style.visibility == "hidden" ) {
				showme.style.visibility = "visible";
			...
			setTimeout(function(){showme.style.visibility = "hidden"; }, 500);
				...
				document.getElementById('colnh').addEventListener('click', function(){click=0;});
				relod();
...
function changeHeight() {
		...
		var showme = document.getElementById("visiblerect2");
		var current = document.getElementById('rect1').getBBox().height;
		var button2 = document.getElementById("bottombtn");
		var button = document.getElementById("tapbutton");
		var current2 = document.getElementById('visiblerect').getBBox().height;
		var r = document.getElementById("volumeid");
			var a = r.transform.baseVal.consolidate().matrix.a;
			var b = r.transform.baseVal.consolidate().matrix.b;
			var c = r.transform.baseVal.consolidate().matrix.c;
			var d = r.transform.baseVal.consolidate().matrix.d;
			var x = r.transform.baseVal.consolidate().matrix.e;
			var y = r.transform.baseVal.consolidate().matrix.f;
		var t = document.getElementById("voltext");
			var a1 = t.transform.baseVal.consolidate().matrix.a;
			var b1 = t.transform.baseVal.consolidate().matrix.b;
			var c1 = t.transform.baseVal.consolidate().matrix.c;
			var d1 = t.transform.baseVal.consolidate().matrix.d;
			var x1 = t.transform.baseVal.consolidate().matrix.e;
			var y1 = t.transform.baseVal.consolidate().matrix.f;
